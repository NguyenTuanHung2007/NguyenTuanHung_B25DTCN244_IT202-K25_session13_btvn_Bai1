...
DELIMITER //
	CREATE TRIGGER PreventPasAppointments
		BEFORE UPDATE ON Appointments
        FOR EACH ROW
        BEGIN
			-- IF OLD.appointment_date < NOW() THEN (cái này dùng để tái hiện lỗi, bỏ comment và chạy phần update).
...
UPDATE Appointments 
SET appointment_date = '2024-01-01 08:00:00' 
